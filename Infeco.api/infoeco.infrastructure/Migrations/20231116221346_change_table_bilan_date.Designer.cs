...
namespace Infoeco.infrastructure.Migrations
{
    ...
    [Migration("20231116221346_change_table_bilan_date")]
    partial class change_table_bilan_date
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.AppartementEntite", b =>
                {
                    ...
                    b.Property<string>("NomResidence")
                        .HasColumnType("text");

                    b.Property<double>("NombreDeMetre2")
                        .HasColumnType("double precision");

                    b.Property<int?>("NumeroAppartement")
                        .HasColumnType("integer");

                    b.Property<double>("PrixDesCharges")
                        .HasColumnType("double precision");

                    b.Property<int?>("TypeAppartementId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.BilanEntite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.CiviliteEntite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.LocataireAppartementEntite", b =>
                {
                    ...
                    b.HasAlternateKey("LocataireId", "AppartementId");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.TypeAppartementEntite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TypeAppartement");
                });

            modelBuilder.Entity("Infoeco.infrastructure.Entities.TypePaiementEntite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.AppartementEntite", b =>
                {
                    ...
                    b.HasOne("Infoeco.infrastructure.Entities.TypeAppartementEntite", "TypeAppartement")
                        .WithMany()
                        .HasForeignKey("TypeAppartementId");
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.LocataireAppartementEntite", b =>
                {
                    b.HasOne("Infoeco.infrastructure.Entities.AppartementEntite", "Appartement")
                        .WithMany("LocatairesAppartements")
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.LocataireEntite", b =>
                {
                    b.HasOne("Infoeco.infrastructure.Entities.CiviliteEntite", "Civilite")
                        .WithMany()
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.PaiementEntite", b =>
                {
                    ...
                    b.HasOne("Infoeco.infrastructure.Entities.TypePaiementEntite", "TypePaiement")
                        .WithMany()
            ...
            modelBuilder.Entity("Infoeco.infrastructure.Entities.AppartementEntite", b =>
                {
                    b.Navigation("LocatairesAppartements");
                });
